#' Calculate the alpha-hull complement
#'
#' Derives circular and half-plane complement components from a Delaunay mesh.
#'
...
#' @param alpha Non-negative alpha radius in the coordinate units.
#'
#' @return A matrix describing complement components and their geometry.
#' @examples
#' coordinates <- rbind(c(0, 0), c(1, 0), c(1, 1), c(0, 1), c(0.5, 0.5))
#' components <- complement(coordinates, alpha = 0.8)
#' head(components)
#' @export
complement <-
